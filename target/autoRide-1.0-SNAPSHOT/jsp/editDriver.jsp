...
<body className='snippet-body'>
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-control" id="vehicle">
                                <option id="CycleOption" value="Cycle">Cycle</option>
                                <option id="CarOption" value="Car">Car</option>
                                <option id="PickupOption" value="Pickup">Pickup</option>
                            </select>
                        </div>
                        <br>
                        <div class="col-md-12">
                            ...
                            <input type="text" id="vehicleRegNo" class="form-control" placeholder="AB0X-1000" value="${vehicleRegNo}">
                        </div>
                        <div class="col-md-12">
                            ...
                            <input type="text" id="licenseNo" class="form-control" placeholder="A000000" value="${licenseNo}">
                        </div>
                    </div>
                </div>
            </div>
        <form id="updateDriverFunction" method="POST" action="./adminUpdateUser" hidden>
            ...
            <input type="text" id="vehicleTypeInput" name="vehicleTypeInput" value="${vehicleType}">
    ...
    <script type='text/javascript'>
        var currentVehicleType = document.getElementById("vehicleTypeInput").value;
        switch(currentVehicleType){
            case "1":
                document.getElementById("CycleOption").selected=true;
                break;
            case "2":
                document.getElementById("CarOption").selected=true;
                break;
            case "3":
                document.getElementById("PickupOption").selected=true;
                break;
        }
        ...
        function verifyForm(){
            ...
            if (i===1){
                ...
                var form = document.getElementById("updateDriverFunction");
                form.submit();
            }
        }
    </script>
