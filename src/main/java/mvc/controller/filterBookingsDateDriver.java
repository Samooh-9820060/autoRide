 ...
 * @author samoo
 */
public class filterBookingsDateDriver extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            while (resultSet.next()){
                ...
                String driverID = resultSet.getObject(12).toString();
                
                if (driverID.equals(driverIDString)){
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(filterBookingsDateDriver.class.getName()).log(Level.SEVERE, null, ex);
