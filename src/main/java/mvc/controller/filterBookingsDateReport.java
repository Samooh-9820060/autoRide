 ...
 * @author samoo
 */
public class filterBookingsDateReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Date dateDate = Date.valueOf(request.getParameter("selectDateField"));
            ...
            while (resultSet.next()) {
                ...
                // for each driver calculate revenue, distance, duration and bookings and add it
                // to a list
    ...
    private String getRevenue(String userID, String date) throws SQLException {
        ...
        ResultSet resultSet = statement
                .executeQuery("SELECT DRIVER, TOTALPRICE, STATUS, CURRENTDATE FROM BOOKINGDETAILS");
        while (resultSet.next()) {
    ...
    private String getDistance(String userID, String date) throws SQLException {
        ...
        ResultSet resultSet = statement
                .executeQuery("SELECT DRIVER, STATUS, CURRENTDATE, DISTANCE FROM BOOKINGDETAILS");
        while (resultSet.next()) {
            String driverID = resultSet.getObject(1).toString().trim();
            String status = resultSet.getObject(2).toString().trim();
            String currentDate = resultSet.getObject(3).toString().trim();
    ...
    private String getDuration(String userID, String date) throws SQLException {
        ...
        ResultSet resultSet = statement
                .executeQuery("SELECT DRIVER, STATUS, CURRENTDATE, DURATION FROM BOOKINGDETAILS");
        while (resultSet.next()) {
            String driverID = resultSet.getObject(1).toString().trim();
            String status = resultSet.getObject(2).toString().trim();
            String currentDate = resultSet.getObject(3).toString().trim();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(filterBookingsDateReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
